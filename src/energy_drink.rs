...
const POS_X: i32 = 10;
const POS_Y: i32 = 170; // Starting Y position for the energy drink section
...
where 
    ...
    let amount_position = Point::new(POS_X + LABEL_OFFSET + 5, POS_Y + 30);
    let price_position = Point::new(POS_X + LABEL_OFFSET + FIELD_WIDTH + 15, POS_Y + 30);
